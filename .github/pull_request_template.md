...
1. Carefully read each question in the pull request docker.
...
4. Do not remove the HTML comment tags, as this will break the Pull Request docker.
...
- [ ] 🔍 My code follows the [style guidelines](https://github.com/homelab-alpha/docker/blob/main/CODE_STYLE_AND_STANDARDS_GUIDES.md) of this project.
...
- [ ] 📚 I have read and understood the [Pull Request Guidelines](https://github.com/homelab-alpha/docker/blob/main/CONTRIBUTING.md#pull-requests).
- [ ] ✍️ I have completed the [Author Self-Review Process](https://github.com/homelab-alpha/docker/blob/main/.github/review_process_template.md).
